...
-- 2. Insert Initial History Records
INSERT INTO spp_history (element_id, code, name, description, parent_id, status, level, valid_from, is_current)
SELECT id, code, name, description, parent_id, status, level, CURRENT_TIMESTAMP - INTERVAL '30 days', TRUE
FROM spp_elements;
...
-- Администрация связана с финансовым и кадровым отделами
...
-- Create view for current SPP structure
